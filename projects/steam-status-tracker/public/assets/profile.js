...
function renderDescription(value) {
  const element = byId('profileDescription');
  if (!element || element.dataset.description === value) return;
...
function renderOverview() {
  ...
  renderOverviewCard('steam', steam ? {
    ...
    activity:steam.player.gameName?'Игра сейчас запущена':'Игра не запущена',
